...
| Attribute | Description |
| --- | --- |
| `text-alignment` | reactions: where the pill docks along the bubble's bottom edge — start, center, or end (the default trailing dock). A literal name: the dock is a static design choice, like anchor placement. |
