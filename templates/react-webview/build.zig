...
const default_native_sdk_path = "vendor/native-sdk";
const app_exe_name = "generated-app";
...
pub fn build(b: *std.Build) void {
    ...
    const frontend_install = b.addSystemCommand(&.{ "npm", "ci", "--ignore-scripts", "--prefix", "frontend" });
